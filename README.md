...
Files which already exist on the local volume are skipped.
...
*   `DELETE_AFTER_DOWNLOAD`: Set to `true` to delete the timelapse from the printer after downloading. Defaults to `false`.
